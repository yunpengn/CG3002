 ...
 * Author: Ang Zhi Yuan
 *
 * Created on 19 September, 2018, 11:35 AM
 */
...
int main(int argc, char** argv) {
    ...
    while (1) {
        ...
        if (rx_length > 0) {
            ...
            int count = write(uartFileStream, rx_buffer, rx_length);		//Filestream, bytes to write, number of bytes to write
            if (count < 0) {
