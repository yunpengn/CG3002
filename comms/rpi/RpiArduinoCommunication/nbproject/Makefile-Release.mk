...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rpiarduinocommunication.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rpiarduinocommunication.exe: ${OBJECTFILES}
...
${OBJECTDIR}/MlCommunication.o: MlCommunication.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MlCommunication.o MlCommunication.cpp
